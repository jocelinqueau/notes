export default class ShrinkGrow extends HTMLElement {
    constructor() {
        ...
        this.playPause = (()=>{
            ...
            this.container.style.animationPlayState = "paused" === t ? "running" : "paused",
            this.button.setAttribute("aria-label", "paused" === t ? "pause" : "play")
        }
        ),
        this.observe = (()=>{
            if (this.render(),
            !this.static && (this.observable && this.setDenominator(),
            this.container = this.shadowRoot.querySelector(".container"),
            this.inner = this.shadowRoot.querySelector(".inner"),
            this.observable && (this.currentWidth = this.translateWidth(this.inner.offsetWidth),
            this.metaElem = this.shadowRoot.querySelector(".width"),
            this.metaElem.textContent = this.currentWidth.toFixed(this.decPlaces)),
    ...
    static get observedAttributes() {
        return ["wide", "narrow", "height", "duration", "unit", "label", "noPad", "static"]
    }
    ...
    get label() {
        return this.getAttribute("label") || "Responsive demonstration of the layout"
    }
    set label(t) {
